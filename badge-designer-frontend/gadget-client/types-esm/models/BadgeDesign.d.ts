...
import { Query, IDsList, PromiseOrLiveIterator, BadgeDesign, AvailableBadgeDesignSelection, BadgeDesignSort, BadgeDesignFilter, CreateBadgeDesignInput } from "../types.js";
...
*/
export type SelectedBadgeDesignOrDefault<Options extends Selectable<AvailableBadgeDesignSelection>> = DeepFilterNever<Select<BadgeDesign, DefaultSelection<AvailableBadgeDesignSelection, Options, typeof DefaultBadgeDesignSelection>>>;
/**
 ...
 * ```
 */
export type BadgeDesignRecord<Selection extends AvailableBadgeDesignSelection | undefined = typeof DefaultBadgeDesignSelection> = DeepFilterNever<GadgetRecord<SelectedBadgeDesignOrDefault<{
    select: Selection;
}>>>;
export declare const DefaultBadgeDesignSelection: {
    readonly __typename: true;
    readonly id: true;
    readonly backgroundColor: true;
    readonly backingPrice: true;
    readonly backingType: true;
    readonly basePrice: true;
    readonly createdAt: true;
    readonly designData: true;
    readonly designId: true;
    readonly productId: true;
    readonly shopId: true;
    readonly status: true;
    readonly textLines: true;
    readonly totalPrice: true;
    readonly updatedAt: true;
    readonly userId: true;
};
declare const modelApiIdentifier: "badgeDesign";
declare const pluralModelApiIdentifier: "badgeDesigns";
 ...
 **/
export type CreateBadgeDesignResult<Options extends CreateBadgeDesignOptions> = SelectedBadgeDesignOrDefault<Options> extends void ? void : GadgetRecord<SelectedBadgeDesignOrDefault<Options>>;
/**
 * The return value from executing getByShop on badgeDesign
 * Is a GadgetRecord of the model's type.
 **/
export type GetByShopBadgeDesignResult<Options extends GetByShopBadgeDesignOptions> = SelectedBadgeDesignOrDefault<Options> extends void ? void : GadgetRecord<SelectedBadgeDesignOrDefault<Options>>;
/**
...
export type BadgeDesignManager = {
    ...
    create: {
        ...
        * * const badgeDesignRecord = await api.badgeDesign.create({
          ...
          * });
        **/
        <Options extends CreateBadgeDesignOptions>(variables: CreateBadgeDesignVariables, options?: LimitToKnownKeys<Options, CreateBadgeDesignOptions>): Promise<CreateBadgeDesignResult<Options>>;
        /**
         * Executes the create action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
        *
        ...
        * * const badgeDesignRecord = await api.badgeDesign.create({
          ...
          * });
        **/
        <Options extends CreateBadgeDesignOptions>(variables: FullyQualifiedCreateBadgeDesignVariables, options?: LimitToKnownKeys<Options, CreateBadgeDesignOptions>): Promise<CreateBadgeDesignResult<Options>>;
        type: 'action';
        ...
        variables: {
            badgeDesign: {
                required: false;
                type: 'CreateBadgeDesignInput';
            };
        };
        variablesType: (((FullyQualifiedCreateBadgeDesignVariables | CreateBadgeDesignVariables)) | undefined);
    ...
    bulkCreate: {
        /**
          ...
          */
        <Options extends CreateBadgeDesignOptions>(inputs: (FullyQualifiedCreateBadgeDesignVariables | CreateBadgeDesignVariables)[], options?: LimitToKnownKeys<Options, CreateBadgeDesignOptions>): Promise<CreateBadgeDesignResult<Options>[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkCreateBadgeDesignsInput!]';
            };
        };
    ...
    getByShop: {
        ...
        **/
        <Options extends GetByShopBadgeDesignOptions>(id: string, options?: LimitToKnownKeys<Options, GetByShopBadgeDesignOptions>): Promise<GetByShopBadgeDesignResult<Options>>;
        type: 'action';
    ...
    bulkGetByShop: {
        /**
          ...
          */
        <Options extends GetByShopBadgeDesignOptions>(ids: string[], options?: LimitToKnownKeys<Options, GetByShopBadgeDesignOptions>): Promise<GetByShopBadgeDesignResult<Options>[]>;
        type: 'action';
...
/**
 * A manager for the badgeDesign model with all the available operations for reading and writing to it.*/
export declare const BadgeDesignManager: {
